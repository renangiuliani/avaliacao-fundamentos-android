...
public class ServiceOrder implements Parcelable {
    ...
    public static List<ServiceOrder> getActive() {
        return ServiceOrdersRepository.getInstance().getActive();
    }

    public static List<ServiceOrder> getArquive() {
        return ServiceOrdersRepository.getInstance().getArquive();
    }
    ...
    public void active() {
        ServiceOrdersRepository.getInstance().active(this);
    }
