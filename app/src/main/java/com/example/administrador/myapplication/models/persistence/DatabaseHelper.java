...
public class DatabaseHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(ServiceOrderContract.alterTable());
        db.execSQL(ServiceOrderUser.createTable());
        db.execSQL("INSERT INTO service_order_user (id, user, password) VALUES (1, 'renan', '123')");
    }
